                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              <Input
                                type="text"
                                value={getInputValue(`wallbox-${config.selectedWallbox.artikelnummer}-meister`, config.selectedWallbox?.customMeisterStunden || 0)}
                                onFocus={(e) => handleInputFocus(e, `wallbox-${config.selectedWallbox.artikelnummer}-meister`)}
                                onChange={(e) => handleInputChange(e, `wallbox-${config.selectedWallbox.artikelnummer}-meister`)}
                                onBlur={(e) => handleInputBlur(e, `wallbox-${config.selectedWallbox.artikelnummer}-meister`, 0, (value) => 
                                  updateProductHours('wallbox', config.selectedWallbox.artikelnummer, 'meister', value)
                                )}
                                className="w-16"
                              />
                              ...
                              <Input
                                type="text"
                                value={getInputValue(`wallbox-${config.selectedWallbox.artikelnummer}-geselle`, config.selectedWallbox?.customGesellenstunden || 0)}
                                onFocus={(e) => handleInputFocus(e, `wallbox-${config.selectedWallbox.artikelnummer}-geselle`)}
                                onChange={(e) => handleInputChange(e, `wallbox-${config.selectedWallbox.artikelnummer}-geselle`)}
                                onBlur={(e) => handleInputBlur(e, `wallbox-${config.selectedWallbox.artikelnummer}-geselle`, 0, (value) => 
                                  updateProductHours('wallbox', config.selectedWallbox.artikelnummer, 'geselle', value)
                                )}
                                className="w-16"
                              />
                              ...
                              <Input
                                type="text"
                                value={getInputValue(`wallbox-${config.selectedWallbox.artikelnummer}-monteur`, config.selectedWallbox?.customMonteurStunden || 0)}
                                onFocus={(e) => handleInputFocus(e, `wallbox-${config.selectedWallbox.artikelnummer}-monteur`)}
                                onChange={(e) => handleInputChange(e, `wallbox-${config.selectedWallbox.artikelnummer}-monteur`)}
                                onBlur={(e) => handleInputBlur(e, `wallbox-${config.selectedWallbox.artikelnummer}-monteur`, 0, (value) => 
                                  updateProductHours('wallbox', config.selectedWallbox.artikelnummer, 'monteur', value)
                                )}
                                className="w-16"
                              />
